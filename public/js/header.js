async function renderHeader() {
  ...
  footer.innerHTML = `
    ...
    <div class="container" style="text-align:center; color:#9ca3af; font-size:12px; margin-top: 20px;">
      <p>Note: SkillzMatter eSports organizes only skill-based eSports tournaments. This platform does not involve gambling or betting.</p>
      <p>Privacy Policy © SkillzMatter eSports | Email: <a href="mailto:skillzmatteresports@gmail.com" style="color:#93c5fd">skillzmatteresports@gmail.com</a></p>
      <p>
